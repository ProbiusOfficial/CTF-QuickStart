...
![image-20230511213751065](../.gitbook/assets/202305112137177.png)
...
![image-20230511220616100](../.gitbook/assets/202305112206154.png)
...
| \_\_unset      | 当使用 unset() 删除一个对象的属性时自动调用这个方法，可以用来实现属性的访问控制。                 |
